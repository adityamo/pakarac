...
<head>
  ...
  <title>Pakar AC</title>
</head>

<body>
  <nav class="navbar py-2 navbar-expand-lg navbar-light">
    <div class="container">
      <a class="navbar-brand" href="#"><img src="gambar/logo.png" width="250" alt="logo" /></a>
      <button
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
          ...
          <li>
            <a class="btn px-4 btn-primary btn-sm ml-2" href="register.php" role="button">Register</a>
          </li>
  ...
  <!-- <section class="heroAC" style="background-image: url(gambar/bg-hero2.png)">
    <div class="container">
      <div class="row">
  ...
  <section class="heroBWA mt-1 rounded-md">
    <div class="container bg-light p-5">
      <div class="row justify-content-center">
        <div class="col align-self-center">
          <h1 class="mb-1">Temukan Solusi untuk </h1>
          <h1 class="mb-4"> Air conditioner anda</h1>
