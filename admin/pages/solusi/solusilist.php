...
<section class="">
    ...
    <div class="d-flex justify-content-between">
        ...
        <div class="">
            <a href="index.php?page=add-solusi" class="btn btn-md btn-success ">Add Solusi</a>
        </div>
    </div>
    <div class="row pt-2">
        <div class="col-lg-12">
                        ...
                        <table class="table table-bordered table-md">
                            ...
                            <tbody>
                                <?php while ($data = mysqli_fetch_assoc($querySolusi)) { ?>
                                    <tr class="d-flex">
                                        <td class="col-2">
                                            <a class="badge badge-pill badge-primary" href="index.php?page=edit-solusi&id_solusi=<?php echo $data["id_solusi"]; ?>">edit</a> |
